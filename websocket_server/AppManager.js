...
export default class AppManager {
	...
	constructor(storageManager, setupType) {
		this.app = express()
	...
	async enabledHandler(req, res) {
		try {
			...
			const response = await fetch(
				`${this.setupType.getNextcloudUrl()}/index.php/apps/whiteboard/ex_app/settings`,
				{
					method: 'POST',
					headers,
					body: JSON.stringify({
						serverUrl: `${this.setupType.getNextcloudSocketUrl()}/index.php/apps/app_api/proxy/whiteboard_websocket`,
